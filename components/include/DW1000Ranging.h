...
public:
	...
	//initialisation
	static void initCommunication(gpio_num_t myRST = static_cast<gpio_num_t>(DEFAULT_RST_PIN), 
                              gpio_num_t mySS = static_cast<gpio_num_t>(DEFAULT_SPI_SS_PIN), 
                              gpio_num_t myIRQ = static_cast<gpio_num_t>(2));
